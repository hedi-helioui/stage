...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt = $conn->prepare($sql_societe)) {
        ...
        echo "Erreur lors de la préparation de la requête Sociétés: " . $conn->error;
    }
    ...
    if ($stmt = $conn->prepare($sql_interimaire)) {
        ...
        echo "Erreur lors de la préparation de la requête Intérimaires: " . $conn->error;
    }
    ...
    if ($stmt = $conn->prepare($sql_contrat)) {
        ...
        echo "Erreur lors de la préparation de la requête Contrats: " . $conn->error;
    }
